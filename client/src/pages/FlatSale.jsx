...
import {flatSale,} from '../utli/mainData/flatsaledata'

function FlatSale() {
  return (
    <div>
    <div className='flex space-x-5 ml-6'>
    <h1 className="text-[2rem] font-bold text-gray-900 ">Flash Sale</h1> <p className='text-lg text-[2rem] mt-3 font-normal '>(30 Products Found)</p> </div>
